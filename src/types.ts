export declare type GoogleCloudDialogflowV2IntentDefaultResponsePlatforms =
...
export declare type GoogleCloudDialogflowV2IntentMessagePlatform =
  | "PLATFORM_UNSPECIFIED"
  | "FACEBOOK"
  | "SLACK"
  | "TELEGRAM"
  ...
  | "VIBER"
  | "ACTIONS_ON_GOOGLE";
export declare type GoogleCloudDialogflowV2IntentTrainingPhraseType =
  | "TYPE_UNSPECIFIED"
  | "EXAMPLE"
  | "TEMPLATE";
export declare type GoogleCloudDialogflowV2IntentWebhookState =
